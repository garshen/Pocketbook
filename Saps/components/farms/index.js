...
// END_CUSTOM_CODE_farms
(function(parent) {
    var dataProvider = app.data.saps,
        /// start global model properties
        /// end global model properties
        fetchFilteredData = function(paramFilter, searchFilter) {
            var model = parent.get('farmsModel'),
                dataSource;

            if (model) {
                dataSource = model.get('dataSource');
            } else {
                parent.set('farmsModel_delayedFetch', paramFilter || null);
                return;
            }
        ...
        farmsModel = kendo.observable({
            ...
            searchChange: function(e) {
                ...
                fetchFilteredData(farmsModel.get('paramFilter'), searchFilter);
            },
            ...
            itemClick: function(e) {
                var dataItem = e.dataItem || farmsModel.originalItem;

                app.mobileApp.navigate('#components/farms/details.html?uid=' + dataItem.uid);

            },
            addClick: function() {
                app.mobileApp.navigate('#components/farms/add.html');
            },
            editClick: function() {
                var uid = this.originalItem.uid;
                app.mobileApp.navigate('#components/farms/edit.html?uid=' + uid);
            },
            deleteItem: function() {
                var dataSource = farmsModel.get('dataSource');
            ...
            detailsShow: function(e) {
                var uid = e.view.params.uid,
                    dataSource = farmsModel.get('dataSource'),
                    itemModel = dataSource.getByUid(uid);

                farmsModel.setCurrentItemByUid(uid);
    ...
    parent.set('addItemViewModel', kendo.observable({
        ...
        onSaveClick: function(e) {
            var addFormData = this.get('addFormData'),
                filter = farmsModel && farmsModel.get('paramFilter'),
                dataSource = farmsModel.get('dataSource'),
                addModel = {};
            ...
            function saveModel(data) {
                ...
                addModel.ResponsiblePerson = addFormData.personResponsible;
    ...
    parent.set('editItemViewModel', kendo.observable({
        ...
        onSaveClick: function(e) {
            ...
            itemData.set('Address', editFormData.name);
    ...
    if (typeof dataProvider.sbProviderReady === 'function') {
        dataProvider.sbProviderReady(function dl_sbProviderReady() {
            parent.set('farmsModel', farmsModel);
            var param = parent.get('farmsModel_delayedFetch');
            if (typeof param !== 'undefined') {
                parent.set('farmsModel_delayedFetch', undefined);
    ...
    parent.set('onShow', function(e) {
        var param = e.view.params.filter ? JSON.parse(e.view.params.filter) : null,
            ...
            dataSourceOptions = farmsModel.get('_dataSourceOptions'),
            dataSource;
        ...
        farmsModel.set('dataSource', dataSource);
        fetchFilteredData(param);
    });

})(app.farms);

// START_CUSTOM_CODE_farmsModel
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_farmsModel